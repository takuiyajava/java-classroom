...
// * ようこそゲームを開始します。
// * キャラクターを選択してください。
// * [1]キャラクター1 [2]キャラクター2 >> 1
// * ステージ1
// * キャラクター1: ”Say something here”
// * 敵: ”Say something here”
// * 攻撃を選択: [0]攻撃1  [1]攻撃2 >> 1
// * キャラクター1: ”Attack! Say something here”
// * ”Dokkaaan”
// * “ステージ1 クリア”
// * ステージ2
// * キャラクター1: ”Say something here”
// * 敵: ”Say something here”
// * 攻撃を選択: [0]攻撃1  [1]攻撃2 >> 1
// * キャラクター: ”Attack! Say something here”
// * ”Bakoon”
// * “ステージ2 クリア”
// * ステージ3
// * キャラクター1: ”Say something here”
...
//        String stageVillian = "";
//
//        String[] gameText = {"ようこそゲームを開始します。", "キャラクターを選択してください。", "ステージ", "攻撃を選択: ", "の攻撃は失敗した", "GAME OVER"};
//
//        String[] effectSounds = {"ドォォン", "ズドォォン", "バスコム",};
//
//        String[] clearMessage = {"クリア", "おめでとうございます！!"};
//
//        String[] errorMessage = {"選択可能キャラクターがいませんでした。"};
//
//        int stages = 3;
//
...
//
//            // Display Comments
//            String[] characterComment = {heroOne.message(selectedCharacter), heroTwo.message(selectedCharacter),};
//
...
//            String[] villianComment = {villainOne.message(stageProgress), villainTwo.message(stageProgress), villainThree.message(stageProgress),};
//
...
//            // Attack function ==================================
//            // Select attack
//            String[] attackList = {heroOne.attack(0), heroTwo.attack(1),};
//
...
//
//            String[] characterAttackVoice = {heroOne.attackVoice(selectedCharacter), heroTwo.attackVoice(selectedCharacter),};
//
...
//
//            // Random sounds ====================================
//            String[] villianAttackVoice = {villainOne.attackVoice(stageProgress), villainOne.attackVoice(stageProgress), villainOne.attackVoice(stageProgress),};
//            if (isSuccess) {
//                int range = 3;
